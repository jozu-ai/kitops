...
<div class="mt-32 md:mt-40 xl:mt-60 px-6 md:px-12">
  ...
  <div class="space-y-6 w-fit mx-auto mt-22">
    <a href="https://discord.gg/bYeHxpT3" class="border border-gray-02 p-8 md:px-14 md:py-10 flex justify-between gap-8 items-center hover:border-gold transition-colors">
