...
<div id="howdoesitwork" class="mt-32 md:mt-40 xl:mt-60 px-6 md:px-12 text-center max-w-[1152px] content-container">
  ...
  <iframe width="1050" class="max-w-full aspect-video mt-22 mx-auto" src="https://www.youtube.com/embed/1TD-e_wVe4Q?si=ONnBiZJCFICDJoVt&amp;autoplay=0" title="YouTube video player" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
