...
<div class="mt-32 md:mt-40  px-6 md:px-12 text-center content-container">
  ...
  <div class="hidden lg:flex flex-col lg:flex-row justify-center items-center gap-10 lg:gap-4 mt-10 md:mt-14 xl:mt-22">
    <div class="relative inline-block text-left group">
      <button class="kit-button flex items-center gap-2">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 fill-white" viewBox="0 0 4875 4875">
